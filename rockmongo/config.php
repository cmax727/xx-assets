...
$i ++;
//==========
$MONGO["servers"][$i]["mongo_name"] = "cardblanc_dev";//mongo server name
$MONGO["servers"][$i]["mongo_host"] = "54.225.0.112";//mongo host  www.mycardblanc.com
$MONGO["servers"][$i]["mongo_port"] = "10015";//mongo port
$MONGO["servers"][$i]["mongo_db"] = "app18758487";
$MONGO["servers"][$i]["mongo_user"] = "cardblanc";//mongo authentication user name, works only if mongo_auth=false
$MONGO["servers"][$i]["mongo_pass"] = "C4RdbL0nC";//mongo authentication password, works only if mongo_auth=false
$MONGO["servers"][$i]["mongo_timeout"] = 0;//mongo connection timeout
$MONGO["servers"][$i]["mongo_auth"] = false;//enable mongo authentication?

$MONGO["servers"][$i]["control_auth"] = false;//enable control users, works only if mongo_auth=false
$MONGO["servers"][$i]["control_users"]["cardblanc"] = "C4RdbL0nC";//one of control users ["USERNAME"]=PASSWORD, works only if mongo_auth=false
