...
switch($type){
    ...
    case 'hours':
        ...
        $sql = "SELECT tl.date_created, t.hours AS task_hours, t.amount, tl.hours AS hours_logged, p.hourly_rate ";
    ...
    case 'amount_invoiced':
        ...
        $sql .= " LEFT JOIN `"._DB_PREFIX."job` p ON t.job_id = p.job_id ";
        $sql .= " WHERE (i.date_sent >= '$start_date' AND i.date_sent < '$end_date')";
        ...
        foreach($res as $r){
            ...
            <tr>
                ...
                switch($type){
                    ...
                    case 'amount_invoiced': ?>
                    <td>
                        <?php echo print_date($r['date_sent']); ?>
                    </td>
                    <?php
                    break;
                }
